...
- **Medicina de Família/SUS**: 32 questões
- **Ginecologia & Obstetrícia**: 30 questões
- **Pediatria**: 26 questões
- **Cirurgia Geral**: 25 questões
- **Gastroenterologia**: 6 questões
- **Pneumologia**: 5 questões
- **Infectologia**: 4 questões
- **Endocrinologia**: 3 questões
- **Nefrologia**: 3 questões
- **Neurologia**: 3 questões
- **Cardiologia**: 3 questões
- **Hematologia**: 3 questões
- **Reumatologia**: 2 questões
- **Neonatologia**: 2 questões
- **Urgência e Emergência**: 1 questões

## UNESP (200 questões)

- **Medicina de Família/SUS**: 41 questões
- **Ginecologia & Obstetrícia**: 40 questões
- **Pediatria**: 29 questões
- **Cardiologia**: 8 questões
- **Cirurgia Geral**: 8 questões
- **Pneumologia**: 6 questões
- **Endocrinologia**: 6 questões
- **Neonatologia**: 6 questões
- **Infectologia**: 5 questões
- **Cirurgia Vascular**: 5 questões
- **Urologia**: 5 questões
- **Clínica Médica**: 4 questões
- **Nefrologia**: 4 questões
- **Ortopedia**: 4 questões
- **Gastroenterologia**: 4 questões
- **Medicina Intensiva**: 3 questões
- **Psiquiatria**: 3 questões
- **Urgência e Emergência**: 3 questões
- **Reumatologia**: 2 questões
- **Hematologia**: 2 questões
- **Oftalmologia**: 2 questões
- **Clínica Cirúrgica**: 2 questões
- **Neurologia**: 2 questões
- **Anestesiologia**: 2 questões
- **Radiologia**: 1 questões
- **Neurocirurgia**: 1 questões
